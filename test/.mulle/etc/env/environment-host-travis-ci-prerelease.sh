...
#
# MulleHoedown url: ${MULLE_HOEDOWN_URL:-https://github.com/MulleScion/MulleHoedown/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_HOEDOWN_URL="https://github.com/MulleScion/MulleHoedown.git"
